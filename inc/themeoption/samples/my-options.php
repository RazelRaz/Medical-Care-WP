...
//
$prefix = '_medi_my_options';

//
// Create options
//
CSF::createOptions( $prefix, array(
  'menu_title' => 'Medical Options',
  'menu_slug'  => 'csf-demo',
) );
...
CSF::createSection( $prefix, array(
  ...
  'fields' => array(
    ...
    array(
      'id'    => 'opt-medical-logo',
      'type'  => 'media',
      'title' => 'Upload Theme Logo',
      'url'   => false,
    ),

    array(
      'id'      => 'opt-medical-phone',
      'type'    => 'text',
    ...
    array(
      'id'    => 'opt-medical-phone-icon',
      'type'  => 'icon',
      'title' => 'Change Phone Icon',
    ),

    array(
      'id'      => 'opt-medical-email',
      'type'    => 'text',
      'title'   => 'Add Email',
    ...
    array(
      'id'    => 'opt-medical-email-icon',
      'type'  => 'icon',
      'title' => 'Add Email Icon',
    ),
  )
) );
